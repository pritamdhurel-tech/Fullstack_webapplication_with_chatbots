...
export default function AdminGallery() {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      setCaption(''); setEventId(''); setFile(null)
  ...
  async function handleDelete(id) {
    ...
    setSuccess('Image deleted.'); load(); setTimeout(() => setSuccess(''), 3000)
  }

  return (
    <div>
      <PageHeader title="Gallery" subtitle="Upload and manage promotional event photos" />

      {/* Upload panel */}
      <div className="glass-card p-6 mb-8">
        <h2 className="font-display text-base font-semibold mb-5">Upload new image</h2>
